...
- (void)viewDidLoad
{
    ...
    NSString *sqlPath = [documentsDir stringByAppendingPathComponent:@"CoreDataMultiContext.sqlite"];
    NSLog(@"SQLite Path: %@", sqlPath);
}
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [[object valueForKey:@"address"] description];
}
